...
export type Props = {
  ...
  onReset?: ?(e: SyntheticEvent<>, data: ResizeCallbackData) => any,
...
export default class Resizable extends React.Component<Props, State> {
  ...
  render(): ReactNode {
    ...
    const {children, draggableOpts, width, height, handleSize,
        ...
        onResizeStop, onResizeStart, onReset, ...p} = this.props;
    ...
    return cloneElement(children, {
      ...
      children: [
        ...
        <DraggableCore
          ...
          >
          <span className="react-resizable-handle" onDoubleClick={onReset}/>
        </DraggableCore>
      ]
    });
  }
